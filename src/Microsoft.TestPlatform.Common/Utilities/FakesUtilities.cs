...
namespace Microsoft.VisualStudio.TestPlatform.Common.Utilities
{
    ...
    public static class FakesUtilities
    {
        ...
        private static bool IsNetCoreFramework(string runSettingsXml)
        {
            ...
            return config.TargetFrameworkVersionTpV2.Name.IndexOf("netstandard", StringComparison.OrdinalIgnoreCase) >= 0
                   || config.TargetFrameworkVersionTpV2.Name.IndexOf("netcoreapp", StringComparison.OrdinalIgnoreCase) >= 0;
        }
